...
public:
	...
	Work(string e, string s, int ho, double rt, string l, string nm, string sm, int ag, string co, int pr) :Courses(e, s, ho, rt, l), Man(e, s, nm, sm, ag),Programmirovanie(e,s)
	{
		name_of_company = co;
		projects = pr;
	}
